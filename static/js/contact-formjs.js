...
const closeBtn = $('.snackbar-close-btn');
// const f = document.querySelector('.contact-form')
// Functions

function showSnackbar() {
    $('.snackbar').addClass('isShown');
    $('.contain-snac').addClass('c-shown');
    setTimeout(hideSnackbar, 4000);
};

function hideSnackbar() {
    $('.snackbar').removeClass('isShown');
    // f.classList.remove('contact-form--loading')
    $('.contain-snac').removeClass('c-shown');
};


closeBtn.on('click', hideSnackbar);
